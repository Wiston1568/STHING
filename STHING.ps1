# STHING.ps1
# NG Security Toolkit - Dev by Bug & wiston1568
...
function Open-AddonMenu {
    if (Test-Path ".\menu_addons.ps1") {
        . .\menu_addons.ps1
        Open-AddonMenu
    } else {
        Write-Host "`n[!] menu_addons.ps1 not found." -ForegroundColor Red
        Read-Host "Press Enter to continue..."
    }
}
